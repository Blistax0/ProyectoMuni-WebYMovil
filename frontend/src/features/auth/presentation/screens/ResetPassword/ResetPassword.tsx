...
import StepIndicator from '../../../../../core/presentation/components/StepIndicator/StepIndicator';
import CodeInput from '../../../../../core/presentation/components/CodeInput/CodeInput';
          ...
          <main className="reset-content">
            ...
            {step >= 2 && (
              <section className="reset-section fade-in">
                ...
                <div className="field-row">
                  <CodeInput onChange={(code: string) => console.log(code)} />
                  <div className="action-btn">
                    <CustomButton 
                      text="Confirmar" 
                      variant="secondary" 
